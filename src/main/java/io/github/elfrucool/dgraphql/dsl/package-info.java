 ...
 *
 * <ul>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.Query} - Main entry point for building queries</li>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.Block} - Query blocks (predicates, nested, functions)</li>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.Mutation} - Data modification operations</li>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.Filter} - Query filters</li>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.DqlElement} - Base interface for all DSL elements</li>
 * </ul>
 *
 * <h2>Quick Start</h2>
 *
 * <pre>
 * import static io.github.elfrucool.dgraphql.dsl.Query.*;
 * import static io.github.elfrucool.dgraphql.dsl.Block.*;
 * import static io.github.elfrucool.dgraphql.dsl.Func.*;
 * import static io.github.elfrucool.dgraphql.dsl.Filter.*;
 *
 * // Build a query
 * Query query = query(
