...
import io.github.elfrucool.dgraphql.dsl.Alter;
...
public class SchemaExamples {
    ...
    private void predicateWithCount() {
        ...
        Alter alter = Alter.predicate("schemaFriend", "[uid]").withCount();
    ...
    private void predicateWithUpsert() {
        ...
        Alter alter = Alter.predicate("schemaEmail", "string").withIndex("hash").withUpsert();
