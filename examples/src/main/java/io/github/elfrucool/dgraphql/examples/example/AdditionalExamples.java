 ...
 * <ul>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.Directive#groupby(String)} - groupBy aggregation</li>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.Alter} - schema alterations</li>
 *   <li>{@link io.github.elfrucool.dgraphql.dsl.JsonMutation} - JSON-based mutations</li>
 *   <li>Multiple query blocks in a single query</li>
 * </ul>
 *
 * @see io.github.elfrucool.dgraphql.dsl.Directive
 * @see io.github.elfrucool.dgraphql.dsl.Alter
 * @see io.github.elfrucool.dgraphql.dsl.JsonMutation
 */
@Component
