...
import com.github.elfrucool.dgraphql.examples.result.ResultsCollector;
...
public class MutationExamples {
    ...
    private void executeMutation(Mutation mutation, String testName) {
        try {
            ...
            if (mutation instanceof com.github.elfrucool.dgraphql.dsl.Mutation.UpsertRaw upsert) {
